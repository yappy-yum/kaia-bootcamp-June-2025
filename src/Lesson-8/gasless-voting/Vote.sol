...
import { Season } from "./Utils/Season.sol";
import { Ownable } from "./Utils/Ownable.sol";
import { MerkleProof } from "@openzeppelin/contracts/utils/cryptography/MerkleProof.sol";
import { Registry } from "./Registry.sol";
import { ReentrancyGuard } from "./Utils/ReentrancyGuard.sol";

contract Vote is Season, Ownable, ReentrancyGuard {
    ...
    // fake address ... 
    // contract has not deployed yet
    address constant private REGISTRY_CONTRACT_ADDRESS = address(0x4e59b44847b379578588920cA78FbF26c0B4956C);
    ...
    constructor(address _manager, uint candidateSupply) Ownable(_manager) {
        assembly {
    ...
    function getRegistryAddress() external pure returns (address) {
